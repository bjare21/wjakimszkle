    ...
    public class DrinkTypesProfile:Profile
    {
        public DrinkTypesProfile()
        {
            this.CreateMap<AddDrinkTypeRequest, DataAccess.Entities.DrinkType>()
                ...
                .ForMember(dt => dt.ServingTemperature, r => r.MapFrom(p => p.ServingTemperature))
                .ForMember(dt => dt.Glasses, r => r.MapFrom(p => new List<Glass>()));
            ...
            this.CreateMap<DataAccess.Entities.DrinkType, ApplicationServices.API.Domain.Models.DrinkType>()
                ...
                .ForMember(d => d.Glasses, e => e.MapFrom(p => p.Glasses!=null ? p.Glasses.Select(g=>g.Id.ToString()):new List<string>()))
